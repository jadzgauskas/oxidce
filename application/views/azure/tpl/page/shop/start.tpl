...
[{capture append="oxidBlock_content"}]
    ...
    [{/if}]
    [{if $oView->getHotOfferList() }]
        [{include file="widget/product/list.tpl" type=$oViewConf->getViewThemeParam('sStartPageListDisplayType') head="PAGE_SHOP_START_HOTOFFERS"|oxmultilangassign listId="newItems" products=$oView->getHotOfferList() showMainLink=true}]
    [{/if}]
